...
class Player:
    ...
    def __init__(self):
        ...
        # espada
        self.direcao_face     = 'baixo'   # última direção do movimento
        self.espada_cooldown  = 0         # frames até poder atacar de novo
        self.espada_ativa     = False     # True nos frames em que a hitbox existe
        self.espada_timer     = 0         # frames restantes de hitbox visível
        self.espada_rect      = None      # hitbox atual da espada
        self.ESPADA_DURACAO   = 12        # frames que a hitbox fica ativa
        self.ESPADA_COOLDOWN  = 30        # frames de cooldown após ataque
        self.ESPADA_ALCANCE   = 55        # distância da hitbox em px
